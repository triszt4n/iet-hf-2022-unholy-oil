...
module.exports = function (objectrepository) {
    ...
    return function (req, res, next) {
        ...
        if (expDates.length > 0){
            res.locals.bunker.nextExpDate = expDates.sort((a,b) => a.diff(b))[0].format();
        }
        res.locals.bunker.stock_dur = Math.round(sumCalories/(res.locals.bunker.capacity * globalConfig.avarageCalorieIntake));
